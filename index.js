...
const messageSeach = document.querySelector('#message-search')
// THEME
...
const searchMessage = () => {
  const val = messageSeach.value.toLowerCase()
...
messageSeach.addEventListener('keyup', searchMessage)

// Highlight messages card when clicking the menu item
